...
Green1Data:
	...
	db $FF,18,SPEAROW,15,SANDSHREW,15,RATTATA,17,PIKACHU,0
ProfOakData:
...
Green2Data:
	db $FF,19,SPEAROW,16,RATTATA,18,SANDSHREW,20,PIKACHU,0
	db $FF,25,FEAROW,23,SHELLDER,22,VULPIX,20,SANDSHREW,25,RAICHU,0
	db $FF,25,FEAROW,23,TAUROS,22,SHELLDER,20,SANDSHREW,25,RAICHU,0
	db $FF,25,FEAROW,23,VULPIX,22,MAGNEMITE,20,SANDSHREW,25,RAICHU,0
	db $FF,38,SANDSLASH,35,NINETALES,37,CLOYSTER,35,KADABRA,40,RAICHU,0
	db $FF,38,SANDSLASH,35,CLOYSTER,37,MAGNETON,35,KADABRA,40,RAICHU,0
	db $FF,38,SANDSLASH,35,MAGNETON,37,NINETALES,35,KADABRA,40,RAICHU,0
	db $FF,47,SANDSLASH,45,EXEGGCUTE,45,NINETALES,47,CLOYSTER,50,KADABRA,53,RAICHU,0
	db $FF,47,SANDSLASH,45,EXEGGCUTE,45,CLOYSTER,47,TAUROS,50,KADABRA,53,RAICHU,0
	db $FF,47,SANDSLASH,45,EXEGGCUTE,45,TAUROS,47,NINETALES,50,KADABRA,53,RAICHU,0
Green3Data:
	db $FF,61,SANDSLASH,59,ALAKAZAM,61,EXEGGUTOR,61,CLOYSTER,63,NINETALES,65,RAICHU,0
	db $FF,61,SANDSLASH,59,ALAKAZAM,61,EXEGGUTOR,61,TAUROS,63,CLOYSTER,65,RAICHU,0
	db $FF,61,SANDSLASH,59,ALAKAZAM,61,EXEGGUTOR,61,NINETALES,63,TAUROS,65,RAICHU,0
LoreleiData:
